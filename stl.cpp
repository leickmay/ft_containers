...
int main()
{
	...
	for(int i = 42; i < 47; i++)
		modif.push_back(i);
	for (std::vector<int>::iterator it = modif.begin(); it != modif.end(); it++)
		std::cout << *it << std::endl;
